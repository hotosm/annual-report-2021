var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            description: '<h4 class="impact-head">Impact Area:</h4> <strong>Sustainable Cities and Communities</strong> <img style="width: auto; vertical-align: middle;" src="images/icons/city.png" height="35" width="35" />' + '<h3></h3>' + 'Resilience Mappers, a local GIS and mapping community in Uganda, took up the challenge to address the lack of complete spatial data in the informal settlements of Kampala in order to provide relief to the people in these settlements. The main aim was to map out health facilities, education facilities and waste dumping sites in 11 informal settlements in Kawempe division to meet the following objectives:' + '<ul><li>Engage settlement leaders, community NGOs and other OSM communities in Uganda in the project activities</li><li>Train <span style="font-weight: bold; color: #D73F3F;">10 OSM communities</span> in Uganda and teams in the settlements to assist in the field work activities, including in field mapping tools like ODK and OMK</li><li>Generate print maps for stakeholders and update the web map repository and the infographic dashboard</li></ul>' + 'Resilience Mappers mapped all the buildings and roads in the settlements and shared the data with stakeholders including Actogether and the urban authorities such as Kampala Capital City Authority. In addition to the buildings and roads mapped, data users also requested updated information on service points, specifically health facilities, education facilities and solid waste dumping points (both legal and illegal).',
            location: {
