var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            description: '<div class="flourish-embed flourish-chart" data-src="visualisation/10754046"></div><ul><li><strong>2,106</strong> NGO/partner staff trained and using HOT maps</li><li><strong>55,181</strong> downloads from HDX</li><li><strong>1.6 million</strong> place names mapped</li><li><strong>2.7</strong> million amenities mapped</li></ul>',
            location: {
              center: [-8.68740, 23.01151],
              zoom: 2.5,
              pitch: 0,
        ...
        },
        {
            ...
            image: '',
            description: 'HOT Tech aims to provide tools that enable anyone to edit and use open map data in an accessible and inclusive way. The Galaxy project aims to get OSM map data and map data insights, like statistics and data quality, into the right hands at the right time.' + '<br /><br />' + 'For our least technical users, Galaxy delivers a lightweight web portal to map data customizable for download in multiple formats for any user, anywhere in the world.' + '<br /><br />' + 'Users can explore mapathon leaderboards, mapper statistics and data quality to track and motivate their own OSM journey.' + '<br /><br />' + 'The galaxy project also enables us to continuously improve existing tools, such as HOT’s Export tool. Most recently, components of Galaxy have contributed to faster results, seamless integrations and data that users can depend on.' + '<iframe width="100%" height="400" src="https://www.youtube.com/embed/5NNlMv0ClBM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
            location: {
              center: [-8.68740, 23.01151],
              zoom: 2.5,
              pitch: 0,
